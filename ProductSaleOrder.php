...
class ProductSaleOrder extends CI_Controller {
	/**
	...
	public function index(){
		$data['datas'] = $this->Common_model->getProductOrderSale();
		$admin_details = $this->session->userdata('admin_details');
		$data['active'] = 'productSaleOrder';
		$data['title']  = 'Manage Sale Order';
		$data['admin'] = $this->Common_model->get_data_by_id('admin','id',$admin_details['admin_id']);
		$this->load->view('admin/includes/header',$data);
		$this->load->view('admin/productSaleOrder/manageSaleOrder');
		$this->load->view('admin/includes/footer');
	}
	
	public function manageInvoice(){
		$orderId = $this->uri->segment(4);
		$data['datas'] = $this->Common_model->getProductOrderSale1($orderId);
		$data['addToCartDetails']  = $this->Common_model->getAddToCartDetails($data['datas']['addToCartId']);
		$admin_details = $this->session->userdata('admin_details');
		$data['active'] = 'productSaleOrder';
		$data['title']  = 'Manage Invoice';
		$data['admin'] = $this->Common_model->get_data_by_id('admin','id',$admin_details['admin_id']);
		$this->load->view('admin/includes/header',$data);
		$this->load->view('admin/productSaleOrder/manageInvoice');
		$this->load->view('admin/includes/footer');
	}
	...
	public function updateDeliveryStatus(){
		...
		$update = $this->Common_model->update('productSaleOrder',$data,'id',$this->input->post('id'));
		if($update){
			return true;
		}
	}
