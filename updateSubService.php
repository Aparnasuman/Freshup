            ...
            <form role="form" method="post" enctype='multipart/form-data'>
				...
				<div class="box-body">
					<div class="form-group">
					  ...
					  <input type="text" class="form-control" value="<?php echo $details['frenchTitle']; ?>" name="frenchTitle" placeholder="Enter Name">
					  <div class="form-error"><?php echo form_error('frenchTitle'); ?></div>
					</div>
				</div>
				 <input type="hidden" class="form-control" value="<?php echo $details['id']; ?>" name="id">
              <!-- /.box-body -->
